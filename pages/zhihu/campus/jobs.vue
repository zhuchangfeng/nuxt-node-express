    ...
    <div class="campus-jobs">
      <div class="jobs-box">
        <div class="jobs-l">
          ...
          <div class="jobs-post">
            <div class="jobs-HDK55" v-for="i in 10" :key="i">
              <a href="javascript:void" class="link-11ZhH">
                <div class="title-1X3Vf">
                  科学领域运营实习生
                  <span class="prior-31MtI"></span>
                </div>
                <div class="status-3wqaa">
                  <span class="status-3wqaa-js55d">社区内容事业部</span>
                  <span class="status-3wqaa-js55d">市场</span>
                </div>
                <div class="locations-1ik3c">北京市·海淀区</div>
                <div class="jobs-GGG565">发布时间：2015-05-17</div>
              </a>
            </div>
          </div>
        </div>
